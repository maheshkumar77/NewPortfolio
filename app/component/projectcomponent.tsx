        ...
        <div className="flex justify-between items-center mt-20">
          <CardItem
            ...
            className="px-4 py-2 rounded-xl text-xs font-normal dark:text-white">
             {index == 1 ? <p className=" bg-green-600 px-1 py-1 text-white-100 lg:mt-[-30] mt-[-10] "> See Live</p>:<p className="  px-1 py-1 text-white-100 lg:mt-[-30] mt-[-10]">See the code →</p> }
